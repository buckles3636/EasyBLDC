/**
  ...
  * @attention
  *
  * <h2><center>&copy; Copyright (c) 2024 Piak Electronic Design B.V.
...
extern float_t HSO_getCrossOver_Hz(const HSO_Handle handle);
extern fixp30_t HSO_getDelta_theta_pu(const HSO_Handle handle);

extern fixp30_t HSO_getEmfSpeed_pu(const HSO_Handle handle);

extern float_t HSO_getEoffsetThreshold_Hz(const HSO_Handle handle);
extern bool HSO_getFlag_EnableOffsetUpdate(const HSO_Handle handle);
extern bool HSO_getFlag_FilterAdaptive(const HSO_Handle handle);
...
extern float_t HSO_getLPfiltcompPole_rps(const HSO_Handle handle);
extern fixp30_t HSO_getOffsetLimit(const HSO_Handle handle);
extern Vector_ab_t HSO_getOffset_ab_pu(const HSO_Handle handle);
extern float_t HSO_getMaxCrossOver_Hz(const HSO_Handle handle);
extern float_t HSO_getMinCrossOver_Hz(const HSO_Handle handle);
extern fixp30_t HSO_getMinCrossOver_pu(const HSO_Handle handle);
extern fixp30_t HSO_getSpeedLP_pu(const HSO_Handle handle);

extern float_t HSO_getSpeedPole_rps(const HSO_Handle handle);

extern void HSO_resetOffsetLimit(HSO_Handle handle);
...
extern void HSO_setEoffsetThreshold_Hz(HSO_Handle handle, const float_t value);
extern void HSO_setFlag_EnableOffsetUpdate(HSO_Handle handle, const bool value);
extern void HSO_setFlag_FilterAdaptive(HSO_Handle handle, const bool value);
...
extern void HSO_setFluxRef_ab_Wb(HSO_Handle handle, const Vector_ab_t *pFluxRef_ab_Wb);
...
extern void HSO_setLPfiltcompPole_rps(HSO_Handle handle, const float_t value);
...
extern void HSO_setMinCrossOver_pu(HSO_Handle handle, const fixp30_t value);
extern void HSO_setObserverRatio(HSO_Handle handle, const float_t value);

extern void HSO_setOffsetLimit(HSO_Handle handle, const fixp30_t value);
...
/************************ (C) COPYRIGHT 2024 Piak Electronic Design B.V. *****END OF FILE****/
