...
/**
  ...
  * 
  */
static inline void STO_SetPLLGains(STO_PLL_Handle_t *pHandle, int16_t hPgain, int16_t hIgain)
{
...
/**
  ...
  */
static inline void STO_ResetPLL(STO_PLL_Handle_t *pHandle)
{
#ifdef NULL_PTR_CHECK_STO_PLL_SPD_POS_FDB
  if (MC_NULL == pHandle)
  {
...
/**
  ...
  */
static inline void STO_SetPLL(STO_PLL_Handle_t *pHandle, int16_t hElSpeedDpp, int16_t hElAngle)
{
#ifdef NULL_PTR_CHECK_STO_PLL_SPD_POS_FDB
  if (MC_NULL == pHandle)
  {
...
/**
  ...
  */
static inline void STO_SetMinStartUpValidSpeedUnit(STO_PLL_Handle_t *pHandle, uint16_t hMinStartUpValidSpeed)
{
#ifdef NULL_PTR_CHECK_STO_PLL_SPD_POS_FDB
  if (MC_NULL == pHandle)
  {
