...
/**
  ...
  */
static inline void PID_SetLowerOutputLimit(PID_Handle_t *pHandle, int16_t hLowerLimit)
{
...
/**
  ...
  */
inline void PID_SetUpperOutputLimit(PID_Handle_t *pHandle, int16_t hUpperLimit)
{
#ifdef NULL_PTR_CHECK_PID_REG
  if (MC_NULL == pHandle)
  {
