...
/**
  ...
  * @retval none
  */
static inline void HT_SetMechanicalWantedDirection( HT_Handle_t * pHandleHT, uint8_t bMWD )
{
...
/**
  ...
  * @retval none
  */
static inline void HT_SetStart ( HT_Handle_t * pHandleHT, bool value )
{
...
/**
  ...
  * @retval none
  */
static inline void HT_SetRestart ( HT_Handle_t * pHandleHT )
{
...
/**
  ...
  * @retval none
  */
static inline void HT_SetAbort( HT_Handle_t * pHandleHT )
{
